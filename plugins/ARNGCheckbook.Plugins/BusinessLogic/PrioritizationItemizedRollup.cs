...
namespace ARNGCheckbook.Plugins.BusinessLogic
{
    ...
    public class PrioritizationItemizedRollup : PluginBase
    {
            ...
            IOrganizationService service, ITracingService tracingService, Guid prioritizationId)
        {
            ...
            {
                [PrioritizationAttributes.RolledRequestedAmount] = requested,
                [PrioritizationAttributes.RolledValidatedAmount] = validated,
                [PrioritizationAttributes.RolledFundedAmount] = funded
            };
