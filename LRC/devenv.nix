...
{
  # ============================================================
  # Long Range Calendar — Power Platform Development Environment
  # ============================================================
  # Self-contained dev environment for the Long Range Calendar (LRC)
  # Dataverse solution and its PCF calendar component. Mirrors the
  # Checkbook environment but is scoped to this project only.
  #   - .NET SDK (for the pac CLI)
  #   - Node.js (for the PCF calendar control)
  ...
  env = {
    ...
    # Point to this project's solutions and source dirs
  ...
  enterShell = ''
    ...
    # ── Greeting ────────────────────────────────────────────────
    echo ""
    echo "📅 Long Range Calendar — Power Platform Dev Environment"
    echo "──────────────────────────────────────────────────────"
